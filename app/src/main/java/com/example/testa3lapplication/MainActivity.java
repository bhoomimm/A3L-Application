...
public class MainActivity extends Activity
{
    ...
    public void onResume()
    {
        ...
        /* String to access message field from data JSON. */
        final String displayNotification = getString(R.string.json_data_display_message);
        ...
        if(nIntent != null)
        {
            ...
            final String displayMes = nIntent.getStringExtra(displayNotification);
            ...
            if (msg != null && displayNotification !=null && srvTimeStamp != null)
            {
                Log.i(TAG, msg);
                /* Display the message in the UI. */
                final TextView tView = (TextView)findViewById(R.id.textMsgServer);
                tView.append("Server Time Stamp: " + srvTimeStamp + "\nMessage from server: " + msg + "\n display Message: " + displayNotification + "\n\n");
        ...
        msgReceiver = createBroadcastReceiver(msgKey, displayNotification ,timeKey);
     ...
     */
    private BroadcastReceiver createBroadcastReceiver(final String msgKey, final String displayNotification,
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver()
        {
            ...
            public void onReceive(final Context context, final Intent broadcastIntent)
            {
                if(broadcastIntent != null){
                    ...
                    final String displayMesg = broadcastIntent.getStringExtra(displayNotification);
                    ...
                    if (msg != null && srvTimeStamp != null)
                    {
                        ...
                        /* Display the message in the UI. */
                        final TextView tView = (TextView)findViewById(R.id.textMsgServer);
                        tView.append("Server Time Stamp: " + srvTimeStamp + "\nMessage from server: " + msg + "\nMessage from server: " + displayMesg + "\n\n");
                    }
